...
const FourOhFour = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(Message, { className: "return-link", href: "localhost:5000", rel: "noreferrer noopener" }, "Return to Happiness"), 


    React.createElement(Logo, { className: "bear-logo--tears" }), /*#__PURE__*/
    React.createElement(Code, { className: "four-oh-four__code" }, "401"), /*#__PURE__*/
    React.createElement(CodeMessage, { className: "four-oh-four__code-message" }, "Invalid Login Credentials. Please try again."))));
